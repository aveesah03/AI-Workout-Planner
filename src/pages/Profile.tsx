    ...
    return (
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div>
                ...
                <p className="text-[var(--gym-color-muted)]">
            ...
            <Card variant="bordered" className="flex items-center gap-3">
                ...
                <Target className="w-5 h-5 text-[var(--gym-color-accent)]" />
                </div>
                <div>
                <p className="text-xs text-[var(--gym-color-muted)]">Goal</p>
                <p className="font-medium text-sm">{plan.overview.goal}</p>
                </div>
            </Card>
            <Card variant="bordered" className="flex items-center gap-3">
                <div className="w-10 h-10 flex items-center justify-center">
                <Calendar className="w-5 h-5 text-[var(--gym-color-accent)]" />
                </div>
                <div>
                <p className="text-xs text-[var(--gym-color-muted)]">Frequency</p>
                <p className="font-medium text-sm">{plan.overview.frequency}</p>
                </div>
            </Card>
            <Card variant="bordered" className="flex items-center gap-3">
                <div className="w-10 h-10 flex items-center justify-center">
                <Dumbbell className="w-5 h-5 text-[var(--gym-color-accent)]" />
                </div>
                <div>
                <p className="text-xs text-[var(--gym-color-muted)]">Split</p>
                <p className="font-medium text-sm">{plan.overview.split}</p>
                </div>
            </Card>
            <Card variant="bordered" className="flex items-center gap-3">
                <div className="w-10 h-10 flex items-center justify-center">
                <TrendingUp className="w-5 h-5 text-[var(--gym-color-accent)]" />
                </div>
                <div>
                <p className="text-xs text-[var(--gym-color-muted)]">Version</p>
            ...
            <p className="text-[var(--gym-color-muted)] text-sm leading-relaxed">
                {plan.overview.notes}
            </p>
            </Card>
